...
exports.getAllGoodSelectors = getAllGoodSelectors;
...
function getAllGoodSelectors() {
  var listOfSelectorsWithProps = new Set();
...
function getAllGoodSelectorsTableData() {
  ...
  var mapSelectorToCell = function mapSelectorToCell() {
    ...
    return Array.from(selectors).map(function (selector) {
      return {
  ...
  tableData.push.apply(tableData, _toConsumableArray(mapSelectorToCell(getAllGoodSelectors())));
  return tableData;
}
...
if (typeof window !== 'undefined') {
  window.__RESELECT_TOOLS__ = {
    ...
    getAllGoodSelectors: getAllGoodSelectors,
